...
def calculate_score_for_letter(current_letter, position_in_word, is_last_letter, values):
    ...
    elif is_last_letter and current_letter == 'E':
...
def main_program():
    ...
    file_path = r"C:\Users\DELL\Desktop\Sem1\Sem1\Programming language\Python\trees.txt"
    values_file = r"C:\Users\DELL\Desktop\Sem1\Sem1\Programming language\Python\Second try\values.txt"
